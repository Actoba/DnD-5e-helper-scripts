...
$ranged_rows = <<<'END'
	...
	<div class="sheet-row">
		...
		<div class="sheet-col-1-8 sheet-center"><button type="roll" class="sheet-roll" name="roll_RangedDamageCURRENTROW" value="\nFor [[@{rangeddmgCURRENTROW} [Base damage] + @{rangeddmgbonusCURRENTROW} [Damage Bonus] + @{global_ranged_damage_bonus} [Active Ranged Damage Bonus] + 0d0 [Bugfix 0] ]] @{rangeddmgtypeCURRENTROW} damage\nExtra [[@{rangeddmgCURRENTROW}]] damage on a crit" >Damage</button></div>
	</div>
