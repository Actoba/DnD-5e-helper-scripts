...
$melee_header = <<<END
		...
		<div class="sheet-row sheet-sub-header">
			...
			<div class="sheet-col-1-12 sheet-center sheet-small-label sheet-vert-bottom">Type</div>
			<div class="sheet-col-1-8 sheet-center sheet-small-label sheet-vert-bottom">Weilded</div>
			<div class="sheet-col-1-8 sheet-center sheet-small-label sheet-vert-bottom">Properties</div>
			...
			<div class="sheet-col-1-12 sheet-center sheet-small-label sheet-vert-bottom">Base Damage</div>
	...
	<div class="sheet-row">
		...
		<div class="sheet-col-1-12">
			<select name="attr_meleeattackstatCURRENTROW">
				<option value="@{strength_mod}">Normal</option>
		...
		<div class="sheet-col-1-8"><input type="text" name="attr_meleepropertiesCURRENTROW"></div>
		...
		<div class="sheet-col-1-12 sheet-center"><button type="roll" class="sheet-roll" name="roll_MeleeAttackCURRENTROW" value="/em uses @{meleeweaponnameCURRENTROW} to attack\n\n[[1d20 + @{meleetohitCURRENTROW} [To Hit] ]] vs AC\n\n[[@{meleedmgCURRENTROW} [Base damage] + (@{meleeattackstatCURRENTROW} * @{meleeattackweildedCURRENTROW}) [Damage Stat Mod] + @{meleemagicCURRENTROW} [Magic Bonus] ]] @{meleedmgtypeCURRENTROW} damage on a hit" >Attack</button></div>
	</div>
...
$ranged_rows = <<<'END'
	...
	<div class="sheet-row">
		...
		<div class="sheet-col-1-6"><input type="text" name="attr_rangedpropertiesCURRENTROW"></div>
		<div class="sheet-col-1-12" title="Only enter the base damage roll here without any bonuses from stats or other sources"><input type="text" name="attr_rangeddmgCURRENTROW"></div>
		...
		<div class="sheet-col-1-12 sheet-center"><button type="roll" class="sheet-roll" name="roll_RangedAttackCURRENTROW" value="/em uses @{rangedweaponnameCURRENTROW} to attack\n\n[[1d20 + @{rangedtohitCURRENTROW} [To Hit] ]] vs AC\n\n[[@{rangeddmgCURRENTROW} [Base damage] + @{rangedtypeCURRENTROW} [Damage Stat Mod] + @{rangedmagicCURRENTROW} [Magic Bonus] ]] @{rangeddmgtypeCURRENTROW} damage on a hit" >Attack</button></div>
	</div>
