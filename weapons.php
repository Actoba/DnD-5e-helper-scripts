...
$melee_header = <<<END
		...
		<div class="sheet-row sheet-sub-header">
			...
			<div class="sheet-col-1-24 sheet-center sheet-small-label sheet-vert-bottom">&nbsp;</div>
			...
			<div class="sheet-col-1-12 sheet-center sheet-small-label sheet-vert-bottom">Damage</div>
		</div>
END;
...
$melee_rows = <<<'END'
	...
	<div class="sheet-row">
		...
		<div class="sheet-col-1-12 sheet-center"><button type="roll" class="sheet-roll" name="roll_MeleeDamageCURRENTROW" value="For [[@{meleedmgCURRENTROW} [Base damage] + @{meleedmgbonusCURRENTROW} [Damage Bonus] + @{global_melee_damage_bonus} [Active Melee Damage Bonus] + 0d0 [Bugfix 0] ]] @{meleedmgtypeCURRENTROW} damage" >Damage</button></div>
	</div>
...
$ranged_rows = <<<'END'
	...
	<div class="sheet-row">
		...
		<div class="sheet-col-1-12 sheet-center"><button type="roll" class="sheet-roll" name="roll_RangedDamageCURRENTROW" value="For [[@{rangeddmgCURRENTROW} [Base damage] + @{rangeddmgbonusCURRENTROW} [Damage Bonus] + @{global_ranged_damage_bonus} [Active Ranged Damage Bonus] + 0d0 [Bugfix 0] ]] @{rangeddmgtypeCURRENTROW} damage" >Damage</button></div>
	</div>
