...
$melee_rows = <<<'END'
	...
	<div class="sheet-row">
		...
		<div class="sheet-col-1-12 sheet-center"><button type="roll" class="sheet-roll" name="roll_MeleeAttackCURRENTROW" value="&{template:5eDefault} {{weapon=1}} {{title=@{character_name}}} {{subheader=@{meleeweaponnameCURRENTROW}}} {{subheaderright=@{meleeweaponpropsCURRENTROW}}} {{attack=[[1d20 + @{meleetohitCURRENTROW} + (@{global_melee_attack_bonus}) ]]}} {{attackadv=[[1d20 + @{meleetohitCURRENTROW} + (@{global_melee_attack_bonus}) ]]}} {{damage=[[@{meleedmgCURRENTROW} + @{meleedmgbonusCURRENTROW} + (@{global_melee_damage_bonus})  + 0d0]] @{meleedmgtypeCURRENTROW}}} {{critdamage=Additional [[@{meleecritdmgCURRENTROW}]] damage}}" >Attack</button></div>
	</div>
...
$ranged_rows = <<<'END'
	...
	<div class="sheet-row">
		...
		<div class="sheet-col-1-12 sheet-center"><button type="roll" class="sheet-roll" name="roll_RangedAttackCURRENTROW" value="&{template:5eDefault} {{weapon=1}} {{title=@{character_name}}} {{subheader=@{rangedweaponnameCURRENTROW}}} {{subheaderright=@{rangedweaponpropsCURRENTROW}}} {{attack=[[1d20 + @{rangedtohitCURRENTROW} + (@{global_ranged_attack_bonus}) ]]}} {{attackadv=[[1d20 + @{rangedtohitCURRENTROW} + (@{global_ranged_attack_bonus}) ]]}} {{damage=[[@{rangeddmgCURRENTROW} + @{rangeddmgbonusCURRENTROW} + (@{global_ranged_damage_bonus})  + 0d0]] @{rangeddmgtypeCURRENTROW}}} {{critdamage=Additional [[@{rangedcritdmgCURRENTROW}]] damage}}" >Attack</button></div>
	</div>
